    ...
    <div className="w-full py-10">
      <div className="w-full flex gap-10">
        <div className="w-2/3 flex flex-col gap-5">
          <h1 className="text-2x1 font-bold text-black ">
            Cart{" "}
        ...
        <div className="w-1/3 p-4 mt-24 h-[500px] border-[1px] border-zinc-400 rounded-md flex flex-col justify-center gap-4 ">
          <div className="w-full flex flex-col gap-4 border-b-[1px] border-b-zinc-200">
            {userInfo ? (
              ...
              <button className="bg-blue w-full bg-opacity-50 cursor-not-allowed  text-white h-10 rounded-full font-semibold duration-300">
                Continue to checkout
              </button>
            )}
            {!userInfo && (
            ...
            {warningMsg && (
              <div className="bg-[#002d58] text-white p-2 rounded-lg flex items-center justify-between gap-4 ">
                ...
                <IoMdClose
                  ...
                  className="text-3x1 hover:text-red-400 cursor-pointer duration-200"
                />
              </div>
            )}

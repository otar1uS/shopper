...
import { logo } from "../public/assets/images/index.js";
...
top-1 right-1 bg-yellow text-black text-xl"
          ...
          <Link href="/cart">
            <div
              className="flex flex-col justify-center items-center gap-2 h-12 px-5
            ...
            >
              ...
              <span
                className="absolute w-4 h-4 bg-yellow text-black top-0 right-4 

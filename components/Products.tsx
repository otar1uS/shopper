          ...
          <div className="px-2 py-4 flex flex-col  justify-center">
            <div className="flex justify-between py-2">
              ...
              <Link
                ...
                as={`product/${item._id}`}
              >
                <button className="w-24 h-9 bg-white text-black border-[1px]  borer-black  rounded-full flex gap-1 items-center justify-center hover:bg-black hover:text-white duration-300">
                  <span>
                    <GoPlus />
                  </span>
                  Details
